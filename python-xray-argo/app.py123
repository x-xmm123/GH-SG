...
DEFAULT_PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 3000) # 订阅端口，如无法订阅，请手动修改为分配的端口
PORT = DEFAULT_PORT
...
async def generate_links(argo_domain):
    ...
    if NAME and NAME.strip():
        # If NAME is provided, use it as the custom ISP suffix in the format <country>_<NAME>
        # e.g. NAME="阿牛" and country_code="SG" -> "SG_阿牛"
